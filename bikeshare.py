...
month = get_user_input('Now it is time to provide us a month name'\ 
                       'or tell us \'all\' to apply no month filter. \n(e.g. all, jan, feb, mar, apr, may, june) \n> ', MONTHS) 
...
def station_stats(df):
    ...
    print("the most commonly used start_station :", most_common_start_station) 
